...
ActiveRecord::Schema.define(version: 20180821072342) do
  ...
  create_table "spree_order_events_trackers", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
